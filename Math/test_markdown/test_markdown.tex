...
% Create labels for Addresses if the are given in Elsevier format
 ...
 %
  ...
  Address in one element deprecated, but works%
 }
   \MyNewLabel{ADDRTXT}{Another University}{%
  Address for Another University%
 }

% Create labels for Footnotes if they are given in Elsevier format
\MyNewLabel{CORRESPTXT}{1}{Equal contribution}
\MyNewLabel{CORRESPTXT}{2}{Current email address:
\href{mailto:cat@example.com}{\nolinkurl{cat@example.com}}}
...
\corresp[\fnsymbol{thisauthcorresp}]{Corresponding author. \href{mailto:alice@example.com}{\nolinkurl{alice@example.com}}}
...
\author[%
\addrlblbycode{Another University}%
%
%
,\corresplblbycode{1},\corresplblbycode{2}%
]{Cat Memes}

\addrbycode{Another University}
...
% Add author mark
\authormark{Alice Anonymous et al.}
...
\begin{figure}[th]
\includegraphics[width=1\linewidth]{test_markdown_files/figure-latex/fig1-1} \caption{This is the first figure.}\label{fig:fig1}
\end{figure}
...
\begin{figure*}[th]
\includegraphics[width=1\linewidth]{test_markdown_files/figure-latex/fig2-1} \caption{This is a wide figure.}\label{fig:fig2}
\end{figure*}
...
\begin{biography}{%
%
}{\author{Alice Anonymous} A promising young researcher working on her
thesis project.}
\end{biography}
